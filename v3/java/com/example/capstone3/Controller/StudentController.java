...
//    }
    ...
    public ResponseEntity makeReport(@PathVariable int studentid,@PathVariable int captainid ,@Valid @RequestBody Report report){
        studentService.makeReport(studentid,captainid,report);
